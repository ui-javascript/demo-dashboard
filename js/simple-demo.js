...
var xScale_6 = d3.scale.linear()
               .domain([0, d3.max(ex6_data, function(d) { return d[0]; })])
               .range([ex6_padding, w - ex6_padding * 2]); 
var yScale_6 = d3.scale.linear()
               .domain([0, d3.max(ex6_data, function(d) { return d[1]; })])
...
var xScale_7 = d3.scale.linear()
               .domain([0, d3.max(ex7_data, function(d) { return d[0]; })])
               .range([ex7_padding, w - ex7_padding * 2]);
var yScale_7 = d3.scale.linear()
                 .domain([0, d3.max(ex7_data, function(d) { return d[1]; })])
...
var yScale12 = d3.scale.linear()
        .domain([0, d3.max(data12, function(d) { return d.value; })])
        .range([0, h]);
...
d3.selectAll("#ex12")
  .on("click", function() {
    ...
    yScale12.domain([0, d3.max(data12, function(d) { return d.value; })]);
